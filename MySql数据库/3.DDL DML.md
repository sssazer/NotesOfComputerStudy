...
|SHOW CREATE DATABASES 数据库名;|查看指定数据库的创建时的语句|
|USE 数据库名;|选中要操作的数据库|
...
# 3. DCL——COMMIT和ROLLBACK

DCL——Data Control Language，数据控制语言。用于定义数据库、表、字段、用户 的访问权限和安全级别
